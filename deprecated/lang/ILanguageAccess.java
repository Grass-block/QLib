...
public abstract class ILanguageAccess {
    ...
    public void sendMessage(Object sender, String namespace, String id, Object... format) {
        var c = getMessageComponent(Language.locale(sender).locale(), namespace, id, format);
    ...
    public void sendRandomMessage(Object sender, String namespace, String id, Object... format) {
        var block = getRandomMessageComponent(Language.locale(sender).locale(), namespace, id, format);
    ...
    public void broadcastMessage(boolean op, boolean console, String namespace, String id, Object... format) {
        PluginPlatform.instance().broadcastLine((l) -> getMessageComponent(l.locale(), namespace, id, format), op, console);
    }

    public void broadcastRandomMessage(boolean op, boolean console, String namespace, String id, Object... format) {
        PluginPlatform.instance().broadcastLine((l) -> getRandomMessageComponent(l.locale(), namespace, id, format), op, console);
    }
    ...
    public void sendTemplate(Object sender, String namespace, String template) {
        PluginPlatform.instance().sendMessage(sender, TextBuilder.build(this.buildTemplate(Language.locale(sender).locale(), namespace, template)));
    }
