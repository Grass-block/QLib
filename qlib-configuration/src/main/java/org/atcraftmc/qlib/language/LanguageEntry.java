...
public final class LanguageEntry{
    ...
    //send
    public void sendMessage(Object sender, String id, Object... format) {
        this.parent.sendMessage(sender, this.namespace, id, format);
    }

    public void sendRandomMessage(Object sender, String id, Object... format) {
    ...
    public void sendTemplate(Object sender, String template) {
